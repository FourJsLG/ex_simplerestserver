...
CONSTANT _SERVICEURL="http://localhost:6310/ws/r/ex_simplerestserver/accounts"
--CONSTANT _SERVICEURL="http://localhost:6310/ws/r/SimpleREST/accounts"
...
FUNCTION start_client_test()
  ...
  #2
  LET testid = security.RandomGenerator.CreateRandomString(5)
